...
Example usage via executable:
    python inference_docking.py data/checkpoints/docking/checkpoint-80 --run PPO
    --env DrugDiscoveryEnv --episodes 1000 --out rollouts.pkl
    
Example usage w/o checkpoint (for testing purposes):
    evaluate_docking.py --run PPO --env DrugDiscoveryEnv --episodes 1000
"""
...
from env_docking import DrugDiscoveryEnv as env
