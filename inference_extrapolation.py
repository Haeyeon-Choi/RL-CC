...
Example usage via executable:
    python inference_extrapolation.py data/checkpoints/extrapolation/checkpoint-750-1 --run PPO
    --env DrugDiscoveryEnv --episodes 1000 --out rollouts.pkl
    
Example usage w/o checkpoint (for testing purposes):
    python evaluate_extrapolation.py --run PPO --env DrugDiscoveryEnv --episodes 1000
"""
...
from env_extrapolation import DrugDiscoveryEnv as env
